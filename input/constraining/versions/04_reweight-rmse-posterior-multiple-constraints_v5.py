...
ecs_params = scipy.optimize.root(opt, [1, 1, 1], args=(2, 3, 5)).x  # YLH: AR6 target / v5
#ecs_params = scipy.optimize.root(opt, [1, 1, 1], args=(2, 3.5, 6)).x  # YLH: AR7 target
...
accepted = pd.DataFrame(
    {
        # YLH: Gregory ECS already searchsorted to valid_temp_af — no further indexing
        "ECS": ecs_in,
