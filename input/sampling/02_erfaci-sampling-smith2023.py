...
erfaci_sample = scipy.stats.trapezoid.rvs(
    5/24, 19/24, size=samples, loc=-2.2, scale=2.4, random_state=71271
)
...
# overwrite RCMIP
so2 = df_emis_obs.loc[df_emis_obs["variable"] == "Sulfur", '1750':'2023'].values.squeeze()
bc = df_emis_obs.loc[df_emis_obs["variable"] == "BC", '1750':'2023'].values.squeeze()
oc = df_emis_obs.loc[df_emis_obs["variable"] == "OC", '1750':'2023'].values.squeeze()
